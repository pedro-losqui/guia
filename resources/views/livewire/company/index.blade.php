<div>
    ...
    @include('livewire.company.alert')
    ...
    <div class="card card-custom card-stretch mt-5">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">Listagem de empresas</h3>
            </div>
            <div class="card-toolbar">
                Total de registros&nbsp;&nbsp;&nbsp;
                <a href="#" class="btn btn-sm btn-success font-weight-bold">{{ count($companies) }}</a>
            </div>
        </div>
        <div class="card-body">
            @include("livewire.company.list")
        </div>
    </div>
